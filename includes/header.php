<?php 
session_start();
define("APPURL", "http://localhost/Hi-Way_411");
...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="<?php echo APPURL; ?>">HI-WAY<span> 411</span></a>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/bookings.php?id=<?php echo $_SESSION['id']; ?>">Your Reservation</a></li>
